...
public class AlunoServiceImpl implements AlunoService {
    ...
    public Aluno cadastrarAluno(AlunoDTO alunoDTO) {
        Usuario usuario = usuarioRepository.findByEmail(alunoDTO.getEmail());
        if (usuario != null) {
            throw new EmailJaExisteException();
        }

        Aluno aluno = usuarioRepository.save(new Aluno(alunoDTO.getNome(), alunoDTO.getEmail(), alunoDTO.getSenha()));
    ...
    public Aluno alterarAluno(Long id, AlunoDTO alunoDTO) {
        ...
        Usuario usuario = usuarioRepository.findByEmail(alunoDTO.getEmail());
        if (usuario != null && !aluno.getEmail().equals(alunoDTO.getEmail())) {
            throw new EmailJaExisteException();
        }
