...
class AlunoControllerDiffblueTest {
    @Autowired
    ...
    void testBuscarTurmaAluno() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(alunoController)
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType("application/json"))
                .andExpect(MockMvcResultMatchers.content().string("{\"id\":1,\"serie\":\"EF_1ANO\",\"professor_id\":1}"));
    }
    ...
    /**
     * Method under test: {@link AlunoController#criarAluno(AlunoDTO)}
     */
    @Test
