...
class AlunoServiceTest {
    ...
    void testBuscarAlunos() {
        ...
        List<Usuario> actualBuscarAlunosResult = alunoServiceImpl.buscarAlunos(1L);
        verify(usuarioRepository).findById(Mockito.<Long>any());
        assertEquals(1, actualBuscarAlunosResult.size());
    }
    ...
    void testBuscarTurmaAluno() {
        ...
        Turma actualBuscarTurmaAlunoResult = alunoServiceImpl.buscarTurmaAluno(1L);
        verify(turmaAlunoRepository).findTurmaByAlunoId(Mockito.<Long>any());
        assertSame(turma, actualBuscarTurmaAlunoResult);
    }
    ...
    void testBuscarTurmaAluno2() {
        ...
        verify(turmaAlunoRepository).findTurmaByAlunoId(Mockito.<Long>any());
        assertSame(turma2, actualBuscarTurmaAlunoResult);
    }
}
